const books = [
    ...
    { title: "Гаррі Поттер і філософський камінь", author: "Дж. К. Роулінг", genre: "Фентезі", img: "https://chitaka.com.ua/wp-content/uploads/2021/11/Garri-Potter-i-filosofskyj-kamin-237x356.jpg", description: "Пригоди юного чарівника в магічному світі." ,  audio: "D:\Users\USER\Downloads\ОстанняНадія\LastHope\audio\Гаррі Поттер.mp3"},
    ...
    { title: "Перейти темряву", author: "Ірен Роздобудько", genre: "Роман", description: "Пригоди героїв у світі, де світло і тінь визначають усе.", img: "https://sound-books.net/uploads/posts/2022-07/1619680868_temryavu.webp" ,  audio: "" },
